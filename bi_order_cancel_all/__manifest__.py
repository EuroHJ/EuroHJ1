...
{
    'name': ' All in one Cancel Sales,Purchase,Picking,Invoice and Inventory in Odoo',
    'version': '16.0.0.1',
    'category': 'Sales',
    "author": "BrowseInfo",
    "website": "https://www.browseinfo.com",
    'summary': 'cancel stock picking reverse stock picking cancel sale order cancel purchase order delivery order cancel inventory adjustment cancel cancel sales cancel stock move cancel all orders cancel invoice cancel picking cancel inventory reset all orders reverse',
    'description': """
...
Reverse Stock moves Reverse Inventory moves Reverse Stock inventory moves Reverse stock picking moves Reverse stock Inventory moves Reverse inventory picking.
    ...
    'price': 11,
    'currency': "EUR",
    'depends': ['sale_stock','stock_picking_cancel_extended','purchase'],
    'data': [
